<%-- 
    Document   : Edit
    Created on : 13-may-2020, 9:52:27
    Author     : Familia
--%>
            ...
            <form action="NotificacionServlet" method="get">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>Mensaje</label>
                        <input type="text" class="form-control" value='${notificacion.mensaje}' name="mensaje" required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <label>Fecha Inicio</label>
                        <input type="datetime" class="form-control" name="inicio" value='${notificacion.inicio}' placeholder="AAAA-MM-DD HH:MM" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label>Fecha Fin</label>
                        <input type="datetime" class="form-control" name="fin" value='${notificacion.fin}' placeholder="AAAA-MM-DD HH:MM">
                    </div>
                </div>
